...
class Memory:
    ...
    def add_memory(self, memory_content, memory_type, memory_importance, memory_feeling, memory_place, timestamp):
        ...
        INSERT INTO Memories (memory_content, memory_type, memory_importance, memory_feeling, memory_place, timestamp)
        VALUES (?, ?, ?, ?, ?, ?)
        ''', (memory_content, memory_type, memory_importance, memory_feeling, memory_place, formatted_time))
        conn.commit()
        conn.close()
