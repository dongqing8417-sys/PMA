...
class Agent:
    def __init__(self, name="", bio="", goal="", pos="", model="", group="onedollars"):
        self.name = name
        self.bio = bio
        self.goal = goal
        self.old_pos = ""
        ...
        self.emotion = feeling.Emotion(self.model,1,0.5,0.5,0.5,0.5, 0.5)

        self.new_emotion = feeling.Emotion(self.model, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5)
        self.old_emotion = feeling.Emotion(self.model, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5)

        self.needs = feeling.BasicNeed(self.model, 1,0.5,0.5,0.5,1)
